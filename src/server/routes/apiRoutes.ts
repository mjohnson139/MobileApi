...
export function setupAPIRoutes(store: Store): Router {
   ...
   */
  router.post('/state', authenticateAPI, authorize('write'), (req: Request, res: Response): void => {
    try {
   ...
   */
  router.post('/actions/:type', authenticateAPI, authorize('write'), (req: Request, res: Response): void => {
    try {
   ...
   */
  router.get('/screenshot', authenticateAPI, authorize('read'), async (req: Request, res: Response): Promise<void> => {
    try {
   ...
   */
  router.get('/metrics', authenticateAPI, authorize('read'), (_req: Request, res: Response): void => {
    try {
      const state = store.getState();
